...
### Сохранение данных для последующей передачи
...
Для переименования ссылок в новых версиях Git'а можно вылолнить эту команду, также стоит упомянуть, что это также меняет для вас имена удалённых веток. То, к чему вы обращались как pb/master, стало paul/master.
