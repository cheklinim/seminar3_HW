...
### Направление запроса на изменения в репозитории владельца.
...
### Копирование чужого рипозитория

Для того, чтобы скопировать чужой репозиторий для дальнейшей работы с ним, необходимо войти в нужный репозиторий, и нажать в правом верхнем углу на **fork**.
