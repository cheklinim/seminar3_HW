...
Чтобы изменить существующий URL-адрес удаленного репозитория нужно ввести команду

    git remote set-url
Данная команда принимает два аргумента:
1. Имя существующего удаленного репозитория. Например, к распространенным вариантам относятся `origin` и `upstream`.
1. Новый URL-адрес удаленного репозитория.
    * Если переходитb на протокол HTTPS, URL-адрес может выглядеть так:
        
            https://github.com/USERNAME/REPOSITORY.git
    * Если переходити на SSH, URL-адрес может выглядеть так:
        
            git@github.com:USERNAME/REPOSITORY.git

## Удаление удаленного репозитория

Чтобы удалить удаленный URL-адрес из репозитория, нужно ввести команду
...
Для переименования существующего удаленного репозитория используется команда
