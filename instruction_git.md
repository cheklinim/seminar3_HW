...
Хорошим тоном является работа в сторонней ветке (не __master__). Так как пушить мы будем из новой созданной локально ветки, с помощью команды __git push__, запушить мы ничего не сможем, так как такой ветки нет в оригинале. Поэтому используем команду 
