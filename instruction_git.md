...
Вот еще несколько нужных в работе команд:
    ...
    git push origin <название ветки>  - если на локальном ремо мы сделали новые правки, то отпрвить их мы можем с помощью этой команды, разумеется, нужно не забыть сделать commit 