...
### Ответвление чужого репозитория 

Чтобы сделать ответвление чужого репозитория на GitHub (копию чужого репозитория на свой аккаунт) используют кнопку 

    fork

Данная функция делает копию выбранного репозитория  на вашем аккаунте. Откуда вы уже знакомым методом сможете клонировать ее к себе на компьютер. 

Можно просто скопировать ссылку и выгрузить копию выбранного репозитория. Но тогда теряется возможность предложить автору проекта свои внесенные изменения. 

При открытии скачанного репзитория, чтобы попасть непосредственно в него, не забудьте использовать команду терминала (не Git!!)

    cd "название репозитория"

### Предложение внесенных изменений автору проекта

Чтобы предложить автору "форкнутого" репозитория свои внесенные изменения используется кноgка на GitHub 

    pull request

Правилом хороего тона считается при скачивании "форкнутого" репозитория создать новую ветку и в ней производить изменения. 
Если Вы внесете изменения в ветку master, скорее всего они останутся без внимания. 