...
Если мы  хотим  поучаствовать в каком-то  чужом  репозитории, то  мы  должны  сначала сделать свою отдельную копию этого  репозитория. Это   сделать  можем с помощью кнопки “Fork”  (fork - вилка). Т.е. когда мы  делаем fork мы  делаем ответвления.

Если  мы хотим  внести  изменения  в чей-то  проект, то  по  правилам, мы  должны  это  делать  в отдельной  ветке. 

Также,  репозитории , которые  находятся  на  гите, как правило  имеют  файл  [readme.md](http://readme.md) (принято писать капсом)

После того, как мы  внесли  изменения  в локальном  репозитории, мы  отправляем его  в интернет и  далее у нас  появится  кнопка compare and pull request.

Пошаговая  инструкция "Как сделать  pull request":
...
6. На сайте GitHub нажимаем на кнопку pull request и  заполняем   необходимые поля. 
