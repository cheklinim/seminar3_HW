...
**Обрати внимание:** если программа сообщило об ошибке, внимательно прочитай сообщение и выполни то, что написано в теле сообщения (скорее всего, программа попросит тебя дописать команду). 
