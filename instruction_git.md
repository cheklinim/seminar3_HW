...
### Как создать новый удаленный репозиторий в GitHub

Для того, чтобы создать новый репозиторий в GitHub необходимо в правом верхнем углу возле значка профиля нажать на "+", new repository. В открывшемся окне ввести название репозитория, задать права доступа, и создать. Можно выбрать чтобы автоматически создался файл README, он необходим для занесения информации о проекте
...
Для того, чтобы скопировать чужой репозиторий для дальнейшей работы с ним, необходимо войти в нужный репозиторий, и нажать в правом верхнем углу на 

    fork

Откроется окно создания репозитория. В нем можно установить права доступа (открытый, закрытый), внести необходимые изменения в название. В информациии к репозиторию будет указан владелец этого репозитория