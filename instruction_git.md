...
Команда показывает ветви, с которыми ведется локальная работа

    git branch 

##### ветка помеченная "*" означает, что на данной ветке находится указатель HEAD

Если после команды ввести название, то будет создана новая ветка из того состояния репозитория в котором сейчас находится указатель HEAD
