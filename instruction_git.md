...
1. Сделать копию основного проекта;
2. Переместить клон-копию проекта в личный аккаунт (репозиторий) пользователя.

То есть кнопка/команда fork позволяет пользователю вносить изменения к клон-копию, а не в оригинал.

## Клонирование репозитория

После нажатия кнопки **fork** копия чужого репозитория переместиться в рабочий аккаунт пользователя и с ним можно будет работать как удаленно, так и локально.

Чтобы запустить локальную работу с копированным репозиторием, необходимо выполнить следующие действия:
...
6. Выполни стандартную программу проверки статуса: **git status** (обрати внимание на локализацию проекта у себя на ПК: при необходимости правильно открой папку с проектом).

7. Создай новую ветку, в которой будешь работать (это уважение к команде разработчиков и правило хорошего тона):
...
Ну а теперь за работу! Используя инструкцию, которую ты написал ранее (домашнее задание 1 и 2 или инструкция выше), можно многое сделать в Git.
...
Щелчок на этой кнопке откроет экран, где будет форма для описания измненений в проекте, для которого собираемся создать запрос на включение: в этой форме можно присвоить заголовок и снабдить его описанием, чтобы у владельца исходного проекта появился стимул с ним ознакомиться. 
...
Теперь твоя основная работа закончена. Поздравляю!

Теперь владелец исходного проекта может ознакомиться с предложенным тобой изменением и выполнить его слияние, отвергнуть его или оставить к нему комментарий. 

Стоит отметить, что эту работу владелец первоначального проекта может делать непосредственно на портале GitHub: для этого у него после открытия твоей части проекта появится окно, где владелец проекта может изучить вносимые поправки, выделить необходимую строку и написать для нее комментарий.

Если владелец исходного проекта добавит комментарий, ты получишь уведомление. После этого можешь выполнить ряд операция по доработке проекта и повторно отправить владельцу первоначального проекта, повторив команды, описанные выше. 

После получения итоговой версии, владелец проекта может нажать на кнопку принять или отказать (в зависимости от его личных целей).