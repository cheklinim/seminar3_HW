...
При выполнении команды git pull вместе с копированием содержимого удаленного репозитория, также выполняет merge содержимого удаленного и локального репозиториев.