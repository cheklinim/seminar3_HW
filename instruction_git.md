...
### Копирование репозитория с Git Hub

Чтобы скопировать репозиторий для работы с Git Hub, нужно сначала на Git Hub скопировать ссылку на него (кнопка Code), и далее ввести команду

    git clone <ссылка на репозиторий>

### Направление изменений в удаленный репозиторий
...
### Подгрузка версии из удаленного репозитория
