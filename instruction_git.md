...
## Раббота с удаленными репозиториями
...
# Создание локальной копии репозитория с GitHub

Для создания копии, существующего репозитория, надо ввести команду:
...
Для работы с чужим репозиторием, необходимо создать копию проекта, через функцию fork на GitHub.
...
Далее, создаем новую папку, прописывем команду git clone, после клонирования, не забываем создать новую ветку для работы, передтем как пушить изменения. 
