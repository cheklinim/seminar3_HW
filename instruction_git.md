...
### Предложение своих изменений в чужом проекте

Чтобы предложить свои изменения в проекте, нужно воспользоваться функцией 'pull request'. После этого, владелец репозитория увидит предлагаемые изменения и должен будет принять решение - Произвести слияние, либо отказаться от предлагаемых изменений.