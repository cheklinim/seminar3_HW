...
### Предложение изменений владельцу репозитория который был скопирован 

После того как вы внесли измения в репозиторий и сделали **git push** в свой удаленный репозиторий, вы можете предложить владельцу скачанного репозитория внести изменения в проект. Для этого на github необходимо создать pull request.

После этого необходимо нажать на сайте github зеленую кнопку **Compare and pull request**
После нажатия на нее вам будет предложено оставить коментарий разработчику проекта и отправить ваши изменения, а владелец проекта уже решает принимать или не принимать их.
